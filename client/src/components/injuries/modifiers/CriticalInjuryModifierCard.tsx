...
import AddCriticalInjuryModifier from "./AddCriticalInjuryModifierDialog";
                ...
                <TableFooter>
                    <TableRow>
                        <Button variant='contained' color='primary' onClick={addRow} startIcon={<AddIcon/>}>Add
                            Modifier</Button>
                        {openDialog && <AddCriticalInjuryModifier open={openDialog}
                                                                onClose={(): void => setOpenDialog(false)} injury={injury}/>}
                    </TableRow>
                </TableFooter>
            )
        } else {
